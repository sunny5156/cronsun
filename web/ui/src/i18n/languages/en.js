var language = {
  ...
  'job type': 'Job type',
  'common job': 'Common',
  'common job help': 'like crontab',
  'single node single process': 'Single Node Single Process',
  'single node single process help': 'only one job can be run',
  'group level common': 'Group Level Common',
  'group level common help': 'we merge all selected nodes as a large node, then the job\'s behavior will looks like a Common job in a single node.',
