...
<template>
  <div id="app">
    <div class="ui blue inverted menu fixed">
      ...
      <a class="item" href="https://moji.wemomo.com/wiki/42490" target="_blank"><i class="external alternate icon"></i> 帮助</a>
      <a class="item" href="http://ad-prism.wemomo.com/" target="_blank"><i class="dashboard icon"></i> AdPrism</a>
